...
<FormView ID="LoggaInForm" runat="server">
    ...
    <p>För att kunna lägga till , ändra , ta bort bilannonser så  var vänlig och logga in <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%$ RouteUrl:routename=User %>' Text="Logga In" CssClass="SitMasterColor" /></p>
